...
/**
 * AgriLink — Roles Section (Who it's for)
 * Path: components/home/Roles.tsx
 */
...
const ROLES = [
  ...
  },
  {
    ...
    points: ["Bulk order management", "Verified farmer network", "Faster settlements"],
  },
  {
    icon: Store,
    title: "Retailers",
  ...
  },
  {
    icon: ShoppingBasket,
    title: "Consumers",
    description: "Know where your food comes from and support local farmers.",
    points: ["Farm-fresh produce", "Transparent pricing", "Support local growers"],
  },
];
